...
var _default = exports["default"] = function _default(_ref) {
  ...
  return {
    visitor: {
      ...
      VariableDeclarator: {
        exit: function exit(path) {
          var _path$parentPath3;
          if ((_path$parentPath3 = path.parentPath) !== null && _path$parentPath3 !== void 0 && _path$parentPath3.isVariableDeclaration() && path.parentPath.node.kind !== "const" && (0, _astUtils.isUndefined)(path.get("init"))) {
            path.node.init = null;
          }
          var id = path.get("id");
