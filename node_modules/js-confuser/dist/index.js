...
function obfuscate(_x, _x2) {
  return _obfuscate.apply(this, arguments);
}
function _obfuscate() {
  _obfuscate = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(sourceCode, options) {
    var obfuscator;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          obfuscator = new _obfuscator["default"](options);
          return _context.a(2, obfuscator.obfuscate(sourceCode));
      }
    }, _callee);
  }));
  return _obfuscate.apply(this, arguments);
}
function obfuscateAST(_x3, _x4) {
  return _obfuscateAST.apply(this, arguments);
}
function _obfuscateAST() {
  _obfuscateAST = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(ast, options) {
    var obfuscator;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          obfuscator = new _obfuscator["default"](options);
          return _context2.a(2, obfuscator.obfuscateAST(ast));
      }
    }, _callee2);
  }));
  return _obfuscateAST.apply(this, arguments);
...
function _obfuscateWithProfiler() {
  _obfuscateWithProfiler = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(sourceCode, options) {
    var _profiler,
      startTime,
      obfuscator,
      totalTransforms,
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          beforeParseTime = performance.now();
          ast = _obfuscator["default"].parseCode(sourceCode);
          parseTime = performance.now() - beforeParseTime;
          ...
          obfuscator.plugins.forEach(function (_ref) {
            var pluginInstance = _ref.pluginInstance;
